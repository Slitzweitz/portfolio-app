...
export const apiData = {
  header: {
    ...
    explanation: "A basic API that parses request headers. Lots of important information is sent as part of the header, like OS, language, and the IP address of the sender."
  },
  shortener: {
    ...
    queryType: "text",
    skills: ["MongoDB", "Nodejs", "Express", "API", "Routes"],
    explanation: "One of my favorite parts of writing this API was integrating a database. It also opened my eyes to how fast a database starts to fill up when an app is connected, and the reasons behind designing an efficent schema (i.e., Mongoose). I wrote multiple routes for this API to perform unique tasks on the same set of data. Implementation of URL validation also sharpened my Regex skills."
  },
  image: {
    ...
    queryType: "text",
    skills: ["Nodejs", "Express", "Google CSE", "Google Cloud Platform", "Abstraction Layer"],
    explanation: "This project taught me how to consume an outside API for use in my own Node and Express projects. The ability to have the access to search results is becoming an integral part of daily life online and in applications, and I created my own instance of Google's Custom Search Engine, and am using Google Cloud Platform to run it."
  },
  timestamp: {
    ...
    queryType: "text",
    skills: [""],
    explanation: "Wrote Express routes to handle both Unix time in seconds and a natural date. Interesting working with spaces in parameters/queries"
  },
  sizer: {
    ...
    queryType: "file",
    skills: [],
    explanation: "As one of the more complicated projects, writing this API taught me "
  }
}
